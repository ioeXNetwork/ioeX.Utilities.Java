...
import org.ioexnetwork.api.Verify;
...
//        File file = new File(courseFile + "/src/main/resources/java-config.json");
            ...
            Config.setFee(Util.multiplyAmountIOEX(new BigDecimal(fee), ioeXPrecision).longValue());
            ...
            Config.setRegisterAssetFee(Util.multiplyAmountIOEX(new BigDecimal(registerAssetFee), ioeXPrecision).longValue());
            if (confirmation == 0){
